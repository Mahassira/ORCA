...
(function(){
  ...
  if(!prefersReduced && window.gsap && window.ScrollTrigger){
    ...
    gsap.utils.toArray('.oc-principle').forEach(function(el, i){
    ...
    gsap.utils.toArray('.oc-member').forEach(function(row){
      var media = row.querySelector('.oc-member-media');
      var copy = row.querySelector('.oc-member-copy');
